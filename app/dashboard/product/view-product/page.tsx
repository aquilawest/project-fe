            ...
            <div className="  p-6 bg-white rounded-lg">
              ...
              <div className={'flex flex-col gap-4 justify-center'}>
                  ...
                  <div className={'text-center '}>
                      <h2 className={'font-bold text-2xl'}>Biro</h2>
                  </div>
...
Edit product
                  ...
                  <div>
                      <div className={'text-start  mb-4 '}>
                          ...
                          <p className={'text-lg font-bold '}>biro</p>
                      </div>
                      ...
                      <div className={'text-start  mb-4 '}>
                          ...
                          <p className={'text-lg font-bold '}>N 5,000</p>
                      </div>
                      ...
                      <div className={'text-start  mb-4 '}>
                          ...
                          <p className={'text-lg font-bold '}>For writing...</p>
                      </div>
